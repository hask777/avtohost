...
axios.get('http://fast-beach-07156.herokuapp.com/api/stat/vol/' + brand, config).then(function (response) {
  ...
  for (car in volume) {
    // console.log(cars[car]);
    newVOL = volume[car]; // console.log(newCar.length);

    for (i = 0; i < newVOL.length; i++) {
      // console.log(newCar[i].car_year);
      carsYear2.push(newVOL[i].car_volume);
      carsCount2.push(newVOL[i].car_count);
    } // console.log(carsYear);
    // console.log(carsCount);
...
__webpack_require__(/*! C:\Users\HASK-PC\Desktop\sites\blog\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\Users\HASK-PC\Desktop\sites\blog\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\Users\HASK-PC\Desktop\sites\blog\resources\css\app.css */"./resources/css/app.css");
